...
public class FuncionarioController : ControllerBase
{
    ...
    public IActionResult Criar(Funcionario funcionario)
    {
        ...
        try{
            tableClient.UpsertEntityAsync(funcionarioLog).Wait();
        }
        catch(Exception ex)
        {
            Console.WriteLine($"Erro ao salvar log no Azure Table Storage: {ex.Message}");
        }
    ...
    public IActionResult Deletar(int id)
    {
        ...
        try
        {
            ...
            return StatusCode(StatusCodes.Status500InternalServerError, $"Erro ao remover o funcionario: {ex.Message}");
        }
        var tableClient = GetTableClient();
